...
const initialState = {bags:false, bottles:false, fenders:false, pumps:false, black:false, white:false, blue:false, red:false, gray:false, navy:false,
                      kands:false, merida:false, trec:false, test2:false, lowPrice:0, highPrice:0};

const CustomAccessoriesSidebar = (props) => {
    ...
    const handleSubmitButton = (e) => {
        ...
        dispatchRedux({type:'FETCH_FILTERED_ACCESSORIES', flag:false, item:filterResponse});
    }
    ...
    const handleSearchFieldChange = (newValue) => {
        ...
        if(newValue !== ''){
            dispatchRedux({type:'FETCH_FILTERED_ACCESSORIES', flag:false, value:newValue, item:{}});
        } else {
            dispatchRedux({type:'FETCH_FILTERED_ACCESSORIES', flag:true, value:'', item:{}});
        }
    }
...
export default CustomAccessoriesSidebar;