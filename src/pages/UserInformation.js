        ...
        <Table sx={{ minWidth: 700, maxWidth:600}} aria-label="simple table">
          <TableHead>
            ...
            <TableRow>  
              ...
              <TableCell style={{fontSize:'20px', fontFamily:'arial'}} align="right">{user.address?.houseNumber} / {user.address?.localNumber}</TableCell>
            </TableRow>  
            <TableRow>  
              <TableCell style={{fontSize:'20px', fontFamily:'arial'}} align="left">Kod pocztowy</TableCell>
              <TableCell style={{fontSize:'20px', fontFamily:'arial'}} align="right">{user.address?.zipCode} {user.city}</TableCell>
            </TableRow>
            <TableRow>  
            ...
            <TableRow> 
              ...
              <TableCell style={{fontSize:'20px', fontFamily:'arial'}} align="right">{user.address?.phone}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
          </TableBody>
